...
- Dart 3.x
- Android Studio o VS Code si quieres usar emuladores o dispositivos Android
- Xcode si quieres compilar iOS en macOS
- Proyecto Firebase configurado
- Un navegador compatible para Web
- Node.js solo si quieres ejecutar el backend en local

## Ejecutar el proyecto

La forma recomendada es entrar en `frontend/` y lanzar Flutter:
...
Ese comando te deja elegir entre emuladores moviles, navegador o cualquier dispositivo conectado.
Si es la primera vez, puedes ejecutar antes `flutter pub get`.

Revisa que `lib/firebase_options.dart` apunte a tu proyecto Firebase.
...
Este frontend vive dentro del monorepo HOTFTP. El backend esta en [`../backend/README.md`](../backend/README.md).
...
No hace falta levantarla para abrir la app si usas la API publica por defecto.
